...
@Component({
  ...
  templateUrl: './produit-par-categorie-Client.component.html',
  styleUrls: ['./produit-par-categorie-Client.component.css']
})
export class ProduitParCategorieClientComponent implements OnInit {
  products: Produit[] = [];
